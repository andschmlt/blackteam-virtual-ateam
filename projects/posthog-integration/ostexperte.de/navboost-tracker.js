/**
 * NavBoost Tracker - ostexperte.de
 * Site Type: International News
 * Vertical: news
...
(function() {
    ...
    // ==========================================
    const CONFIG = {
        SITE_DOMAIN: 'ostexperte.de',
        SITE_TYPE: 'International News',
        VERTICAL: 'news',
    ...
    function init() {
        ...
        log('Initializing NavBoost Tracker for ostexperte.de');
