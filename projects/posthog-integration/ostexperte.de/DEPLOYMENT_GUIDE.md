# Deployment Guide - ostexperte.de Conversion Tracking
...
posthog.init('phc_x1c84l3TE4DFT9aC8FiVPPhZKY1hxLeayEcBR8MrTiH',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/ostexperte_de/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/ostexperte_de/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to ostexperte.de
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for ostexperte.de`
