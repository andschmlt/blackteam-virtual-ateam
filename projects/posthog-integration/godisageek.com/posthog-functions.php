<?php
/**
 * PostHog + NavBoost Integration for godisageek.com
 * PostHog Project ID: 295240
 * Site Type: Gaming News
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function godisageek_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'godisageek_com_enqueue_posthog_scripts');

function godisageek_com_add_body_class($classes) {
...
add_filter('body_class', 'godisageek_com_add_body_class');

function godisageek_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'godisageek_com_track_article_meta');
