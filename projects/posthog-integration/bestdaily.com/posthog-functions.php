<?php
/**
 * PostHog + NavBoost Integration for bestdaily.com
 * PostHog Project ID: 295235
 * Site Type: News/Media
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function bestdaily_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'bestdaily_com_enqueue_posthog_scripts');

function bestdaily_com_add_body_class($classes) {
...
add_filter('body_class', 'bestdaily_com_add_body_class');

function bestdaily_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
    ...
    <script>
        if (typeof posthog !== 'undefined') {
            posthog.register({
                ...
                'content_vertical': 'general_news'
            });
        }
    </script>
    <?php
}
add_action('wp_footer', 'bestdaily_com_track_article_meta');
