# Deployment Guide - theroanokestar.com Conversion Tracking
...
posthog.init('phc_w3UubjrNc7OTuqLfaefR4xlnCiJTfue23FLImnFfvBd',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/theroanokestar_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/theroanokestar_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to theroanokestar.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for theroanokestar.com`
