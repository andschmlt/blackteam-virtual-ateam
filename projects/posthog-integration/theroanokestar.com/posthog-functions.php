<?php
/**
 * PostHog + NavBoost Integration for theroanokestar.com
 * PostHog Project ID: 295255
 * Site Type: News/Media
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function theroanokestar_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'theroanokestar_com_enqueue_posthog_scripts');

function theroanokestar_com_add_body_class($classes) {
...
add_filter('body_class', 'theroanokestar_com_add_body_class');

function theroanokestar_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'theroanokestar_com_track_article_meta');
