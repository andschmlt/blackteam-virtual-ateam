<?php
/**
 * PostHog + NavBoost Integration for starnewsphilly.com
...
function starnewsphilly_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'starnewsphilly_com_enqueue_posthog_scripts');

function starnewsphilly_com_add_body_class($classes) {
...
add_filter('body_class', 'starnewsphilly_com_add_body_class');

function starnewsphilly_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'starnewsphilly_com_track_article_meta');
