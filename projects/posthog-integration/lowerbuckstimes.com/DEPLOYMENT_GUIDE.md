# Deployment Guide - lowerbuckstimes.com Conversion Tracking
...
posthog.init('phc_GfmQiWa33XhxjjMOT5DUtdftF1kF2zd12GGHU607ze8',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/lowerbuckstimes_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/lowerbuckstimes_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to lowerbuckstimes.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for lowerbuckstimes.com`
