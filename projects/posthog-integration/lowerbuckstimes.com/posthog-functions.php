<?php
/**
 * PostHog + NavBoost Integration for lowerbuckstimes.com
 * PostHog Project ID: 295242
 * Site Type: News/Media
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function lowerbuckstimes_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'lowerbuckstimes_com_enqueue_posthog_scripts');

function lowerbuckstimes_com_add_body_class($classes) {
...
add_filter('body_class', 'lowerbuckstimes_com_add_body_class');

function lowerbuckstimes_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'lowerbuckstimes_com_track_article_meta');
