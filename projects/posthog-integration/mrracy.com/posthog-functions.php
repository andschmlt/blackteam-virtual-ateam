<?php
/**
 * PostHog + NavBoost Integration for mrracy.com
 * PostHog Project ID: 295245
 * Site Type: Adult Entertainment
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function mrracy_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'mrracy_com_enqueue_posthog_scripts');

function mrracy_com_add_body_class($classes) {
...
add_filter('body_class', 'mrracy_com_add_body_class');

function mrracy_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
    ...
    <script>
        if (typeof posthog !== 'undefined') {
            posthog.register({
                ...
                'content_vertical': 'adult'
            });
        }
    </script>
    <?php
}
add_action('wp_footer', 'mrracy_com_track_article_meta');
