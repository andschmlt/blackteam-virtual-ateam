# Deployment Guide - mrracy.com Conversion Tracking
...
posthog.init('phc_WOZPaFNksoTFYQu6bmGrSqxAsq1C9ph3DHVboKEcBLT',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/mrracy_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/mrracy_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to mrracy.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for mrracy.com`
