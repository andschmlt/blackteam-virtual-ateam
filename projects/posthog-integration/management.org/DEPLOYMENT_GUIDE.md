# Deployment Guide - management.org Conversion Tracking
...
posthog.init('phc_6KHNR8kD2b5GNeyaoIBVgwVrqvsT3Ofs1T5s38bfbsW',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/management_org/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/management_org/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to management.org
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for management.org`
