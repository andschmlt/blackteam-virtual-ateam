<?php
/**
 * PostHog + NavBoost Integration for snjtoday.com
...
function snjtoday_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'snjtoday_com_enqueue_posthog_scripts');

function snjtoday_com_add_body_class($classes) {
...
add_filter('body_class', 'snjtoday_com_add_body_class');

function snjtoday_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'snjtoday_com_track_article_meta');
