# Deployment Guide - snjtoday.com Conversion Tracking
...
posthog.init('phc_A61d3raTTKbqZOLuRh5hSEtUXzaZ5EPtDCrfBCxQIBu',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/snjtoday_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/snjtoday_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to snjtoday.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for snjtoday.com`
