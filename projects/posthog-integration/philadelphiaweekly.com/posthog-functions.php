<?php
/**
 * PostHog + NavBoost Integration for philadelphiaweekly.com
...
function philadelphiaweekly_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'philadelphiaweekly_com_enqueue_posthog_scripts');

function philadelphiaweekly_com_add_body_class($classes) {
...
add_filter('body_class', 'philadelphiaweekly_com_add_body_class');

function philadelphiaweekly_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'philadelphiaweekly_com_track_article_meta');
