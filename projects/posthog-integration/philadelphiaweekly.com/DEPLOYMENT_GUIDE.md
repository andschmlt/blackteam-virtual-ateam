# Deployment Guide - philadelphiaweekly.com Conversion Tracking
...
posthog.init('phc_7Uz92UNP9iMQMXQ1FncqvmhH0NCHPuei5KLeJb6ZekU',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/philadelphiaweekly_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/philadelphiaweekly_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to philadelphiaweekly.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for philadelphiaweekly.com`
