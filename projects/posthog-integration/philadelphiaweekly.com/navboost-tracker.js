/**
 * NavBoost Tracker - philadelphiaweekly.com
...
(function() {
    ...
    // ==========================================
    const CONFIG = {
        SITE_DOMAIN: 'philadelphiaweekly.com',
        ...
        OUTBOUND_PATTERNS: [
            /^https?:\/\/(?!.*philadelphiaweekly\\.com)/i,
    ...
    function init() {
        ...
        log('Initializing NavBoost Tracker for philadelphiaweekly.com');
