# Deployment Guide - dotesports.com Conversion Tracking
...
posthog.init('phc_8jgdrakp5mAyOcX6sgYFyoNXLOyzqh4b4MDj6rUQubX',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/dotesports_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/dotesports_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to dotesports.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for dotesports.com`
