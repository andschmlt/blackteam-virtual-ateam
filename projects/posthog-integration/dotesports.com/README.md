# NavBoost + PostHog Integration - dotesports.com

**PostHog Project ID:** 291573
**Site Type:** Esports/Gaming News
**GitHub Repo:** ParadiseMediaOrg/dotesports.com
**Generated:** 2026-01-21

## Overview

This package contains everything needed to deploy NavBoost engagement tracking for dotesports.com. NavBoost tracks user engagement signals that correlate with Google's ranking system.
...
git clone git@github.com:ParadiseMediaOrg/dotesports.com.git
cp navboost-tracker.js dotesportscom/wp-content/themes/[your-theme]/js/
```
...
Description: PostHog + NavBoost tracking for dotesports.com
Version: 1.0.0
*/
...
2. Select project: dotesports.com (291573)
