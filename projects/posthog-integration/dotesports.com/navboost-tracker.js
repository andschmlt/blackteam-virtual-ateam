/**
 * NavBoost Tracker - dotesports.com
 * Site Type: Esports/Gaming
 * Vertical: gaming
...
(function() {
    ...
    // ==========================================
    const CONFIG = {
        SITE_DOMAIN: 'dotesports.com',
        SITE_TYPE: 'Esports/Gaming',
        VERTICAL: 'gaming',
    ...
    function init() {
        ...
        log('Initializing NavBoost Tracker for dotesports.com');
