/**
 * NavBoost Tracker - topdocumentaryfilms.com
 * Site Type: Documentary
...
(function() {
    ...
    // ==========================================
    const CONFIG = {
        SITE_DOMAIN: 'topdocumentaryfilms.com',
        SITE_TYPE: 'Documentary',
        VERTICAL: 'entertainment',
        ...
        DWELL_BENCHMARKS: {
            VERY_BAD: 10000,   // < 10s
            WEAK: 30000,       // 10-30s
            NORMAL: 120000, // Target threshold
            STRONG: 120001
        },
        ...
        OUTBOUND_PATTERNS: [
            /^https?:\/\/(?!.*topdocumentaryfilms\\.com)/i,
    ...
    function init() {
        ...
        log('Initializing NavBoost Tracker for topdocumentaryfilms.com');
