# Deployment Guide - topdocumentaryfilms.com Conversion Tracking
...
posthog.init('phc_hMhLAhMtJn35IKWnYw0EAN54EbaWGIC35GSNTQgKTeY',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/topdocumentaryfilms_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/topdocumentaryfilms_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to topdocumentaryfilms.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for topdocumentaryfilms.com`
