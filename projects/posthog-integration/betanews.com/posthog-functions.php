<?php
/**
 * PostHog + NavBoost Integration for betanews.com
 * PostHog Project ID: 295236
 * Site Type: Tech News
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function betanews_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'betanews_com_enqueue_posthog_scripts');

function betanews_com_add_body_class($classes) {
...
add_filter('body_class', 'betanews_com_add_body_class');

function betanews_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
    ...
    <script>
        if (typeof posthog !== 'undefined') {
            posthog.register({
                ...
                'content_vertical': 'tech_news'
            });
        }
    </script>
    <?php
}
add_action('wp_footer', 'betanews_com_track_article_meta');
