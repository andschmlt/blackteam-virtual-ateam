<?php
/**
 * PostHog + NavBoost Integration for warcraftmovies.com
 * PostHog Project ID: 295259
 * Site Type: Gaming
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function warcraftmovies_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'warcraftmovies_com_enqueue_posthog_scripts');

function warcraftmovies_com_add_body_class($classes) {
...
add_filter('body_class', 'warcraftmovies_com_add_body_class');

function warcraftmovies_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'warcraftmovies_com_track_article_meta');
