<?php
/**
 * PostHog + NavBoost Integration for countryqueer.com
...
function countryqueer_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'countryqueer_com_enqueue_posthog_scripts');

function countryqueer_com_add_body_class($classes) {
...
add_filter('body_class', 'countryqueer_com_add_body_class');

function countryqueer_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
    ...
    <script>
        if (typeof posthog !== 'undefined') {
            posthog.register({
                ...
                'content_vertical': 'lifestyle'
            });
        }
    </script>
    <?php
}
add_action('wp_footer', 'countryqueer_com_track_article_meta');
