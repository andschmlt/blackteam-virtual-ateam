<?php
/**
 * PostHog + NavBoost Integration for northeasttimes.com
 *
 ...
 */
function northeasttimes_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'northeasttimes_enqueue_posthog_scripts');

/**
 * Add page template data attribute for NavBoost
 */
function northeasttimes_add_body_class($classes) {
...
add_filter('body_class', 'northeasttimes_add_body_class');

/**
 * Add data attributes to CTAs for better tracking
 */
function northeasttimes_add_cta_attributes($content) {
...
add_filter('the_content', 'northeasttimes_add_cta_attributes');

/**
 * Track article metadata for better analytics
 */
function northeasttimes_track_article_meta() {
    if (!is_single()) {
        return;
    }
...
add_action('wp_footer', 'northeasttimes_track_article_meta');
