# Deployment Guide - silvergames.com Conversion Tracking
...
posthog.init('phc_yHsK3TNqaeIk8PbIIu0VqOuXY19H2kChIbbpS6ApcOD',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/silvergames_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/silvergames_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to silvergames.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for silvergames.com`
