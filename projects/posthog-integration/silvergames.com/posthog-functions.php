<?php
/**
 * PostHog + NavBoost Integration for silvergames.com
 * PostHog Project ID: 295250
 * Site Type: Gaming
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function silvergames_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'silvergames_com_enqueue_posthog_scripts');

function silvergames_com_add_body_class($classes) {
...
add_filter('body_class', 'silvergames_com_add_body_class');

function silvergames_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'silvergames_com_track_article_meta');
