<?php
/**
 * PostHog + NavBoost Integration for thesunpapers.com
 * PostHog Project ID: 295256
 * Site Type: News/Media
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function thesunpapers_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'thesunpapers_com_enqueue_posthog_scripts');

function thesunpapers_com_add_body_class($classes) {
...
add_filter('body_class', 'thesunpapers_com_add_body_class');

function thesunpapers_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'thesunpapers_com_track_article_meta');
