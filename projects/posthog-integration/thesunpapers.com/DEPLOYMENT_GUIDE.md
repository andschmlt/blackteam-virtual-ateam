# Deployment Guide - thesunpapers.com Conversion Tracking
...
posthog.init('phc_2c5WwvvcVY7GfaZtxBHDVxO0p7hEkEGlx1CIHOtcLM4',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/thesunpapers_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/thesunpapers_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to thesunpapers.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for thesunpapers.com`
