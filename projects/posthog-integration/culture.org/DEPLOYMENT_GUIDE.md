# Deployment Guide - culture.org Conversion Tracking
...
posthog.init('phc_WCW3bwmRex1An9pjMFMBFAvVLTrq9I4UVE3PA6yGDqK',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/culture_org/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/culture_org/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to culture.org
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for culture.org`
