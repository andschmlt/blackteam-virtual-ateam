<?php
/**
 * PostHog + NavBoost Integration for centraljersey.com
 * PostHog Project ID: 295237
 * Site Type: News/Media
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function centraljersey_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'centraljersey_com_enqueue_posthog_scripts');

function centraljersey_com_add_body_class($classes) {
...
add_filter('body_class', 'centraljersey_com_add_body_class');

function centraljersey_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'centraljersey_com_track_article_meta');
