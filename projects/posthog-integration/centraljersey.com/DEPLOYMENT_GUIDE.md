# Deployment Guide - centraljersey.com Conversion Tracking
...
posthog.init('phc_DJse5iNBxxftS8JLYNYxcho9pKfIYgfJIqv6fzaAaAR',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/centraljersey_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/centraljersey_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to centraljersey.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for centraljersey.com`
