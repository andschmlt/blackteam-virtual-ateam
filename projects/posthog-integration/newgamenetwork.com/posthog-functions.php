<?php
/**
 * PostHog + NavBoost Integration for newgamenetwork.com
 * PostHog Project ID: 295246
 * Site Type: Gaming News
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function newgamenetwork_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'newgamenetwork_com_enqueue_posthog_scripts');

function newgamenetwork_com_add_body_class($classes) {
...
add_filter('body_class', 'newgamenetwork_com_add_body_class');

function newgamenetwork_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
    ...
    <script>
        if (typeof posthog !== 'undefined') {
            posthog.register({
                ...
                'content_vertical': 'gaming'
            });
        }
    </script>
    <?php
}
add_action('wp_footer', 'newgamenetwork_com_track_article_meta');
