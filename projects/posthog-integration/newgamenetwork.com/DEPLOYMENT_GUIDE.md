# Deployment Guide - newgamenetwork.com Conversion Tracking
...
posthog.init('phc_7i9SHrMx0XXb1C8OzK8DoL6zIxS5tjLHQSE6xHwc7ZY',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/newgamenetwork_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/newgamenetwork_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to newgamenetwork.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for newgamenetwork.com`
