<?php
/**
 * PostHog + NavBoost Integration for southphillyreview.com
 * PostHog Project ID: 295252
 * Site Type: News/Media
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function southphillyreview_com_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'southphillyreview_com_enqueue_posthog_scripts');

function southphillyreview_com_add_body_class($classes) {
...
add_filter('body_class', 'southphillyreview_com_add_body_class');

function southphillyreview_com_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'southphillyreview_com_track_article_meta');
