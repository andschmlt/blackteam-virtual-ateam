# Deployment Guide - pokertube.com Conversion Tracking
...
posthog.init('phc_lVP4GZkbFmBzbkhY8x4xTWqXtT6MwTLKboGUcUW0thW',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/pokertube_com/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/pokertube_com/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to pokertube.com
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for pokertube.com`
