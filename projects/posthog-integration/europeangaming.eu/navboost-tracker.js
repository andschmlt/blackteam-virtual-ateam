/**
 * NavBoost Tracker - europeangaming.eu
 * Site Type: iGaming News
 * Vertical: news
...
(function() {
    ...
    const CONFIG = {
        SITE_DOMAIN: 'europeangaming.eu',
        SITE_TYPE: 'iGaming News',
        VERTICAL: 'news',
        ...
        OUTBOUND_PATTERNS: [/^https?:\/\/(?!.*europeangaming\\.eu)/i, /\/go\//i, /\/out\//i, /\/aff\//i],
        CONVERSION_FORMS: {
    ...
    function init() {
        ...
        log('Initializing NavBoost Tracker for europeangaming.eu');
