# Deployment Guide - europeangaming.eu Conversion Tracking
...
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/europeangaming_eu/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/europeangaming_eu/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to europeangaming.eu
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for europeangaming.eu`
