# Deployment Guide - esports.gg Conversion Tracking
...
posthog.init('phc_UHCLBas5g7FvJMytBR30C3IMyOLs4KJ90t1QY8N9tKx',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/esports_gg/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/esports_gg/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to esports.gg
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for esports.gg`
