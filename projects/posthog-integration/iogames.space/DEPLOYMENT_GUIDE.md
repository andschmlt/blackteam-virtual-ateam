# Deployment Guide - iogames.space Conversion Tracking
...
posthog.init('phc_p3kYqZKK5kPxxhyfGkQv5wEgm02zg4iuIzLr0AIUOb9',{api_host:'https://us.i.posthog.com',capture_pageview:true,capture_pageleave:true,autocapture:true});
</script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/iogames_space/navboost-tracker.min.js"></script>
<script src="https://raw.githubusercontent.com/ParadiseMediaOrg/posthog-trackers/main/iogames_space/conversion-tracker.min.js"></script>
```
...
1. **Deploy code** to iogames.space
2. **Open browser DevTools** → Console
3. **Look for logs:**
   - `[PostHog] Loaded for iogames.space`
