<?php
/**
 * PostHog + NavBoost Integration for iogames.space
 * PostHog Project ID: 295241
 * Site Type: Gaming
 * Generated: 2026-01-21
 */
if (!defined('ABSPATH')) exit;

function iogames_space_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'iogames_space_enqueue_posthog_scripts');

function iogames_space_add_body_class($classes) {
...
add_filter('body_class', 'iogames_space_add_body_class');

function iogames_space_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'iogames_space_track_article_meta');
