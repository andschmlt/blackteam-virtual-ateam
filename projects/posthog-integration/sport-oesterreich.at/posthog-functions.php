<?php
/**
 * PostHog + NavBoost Integration for sport-oesterreich.at
...
function sport_oesterreich_at_enqueue_posthog_scripts() {
...
add_action('wp_enqueue_scripts', 'sport_oesterreich_at_enqueue_posthog_scripts');

function sport_oesterreich_at_add_body_class($classes) {
...
add_filter('body_class', 'sport_oesterreich_at_add_body_class');

function sport_oesterreich_at_track_article_meta() {
    if (!is_single()) return;
    global $post;
...
add_action('wp_footer', 'sport_oesterreich_at_track_article_meta');
